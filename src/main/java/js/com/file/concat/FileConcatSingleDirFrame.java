...
public class FileConcatSingleDirFrame extends JFrame implements ActionListener,DocumentListener{
	...
	//需要打印的文件后缀
	private String[] typeChoiceArray = {"java","bat","xml","h","cpp","c","hpp","sh","txt","php","html","go","json","md"}; 
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FileConcatSingleDirFrame frame = new FileConcatSingleDirFrame();
	 ...
	 * Create the frame.
	 */
	public FileConcatSingleDirFrame() {
	...
	private void init(){
		...
		selectPathButton = new JButton("选择文件");
